...
llm = ChatOpenAI(temperature=0.0, model='gpt-3.5-turbo-16k', openai_api_key=OPENAI_API_KEY)
...
# run_retrieval_qa_pipeline(text="When will Michael Vick appear in court?", instructions='answer in a short poem')